...
public class ConversationListItem extends RelativeLayout implements Contact.UpdateListener,
    ...
    private void updateBackground() {
        if (mConversation.isChecked()) {
            ...
            setBackgroundColor(sp.getInt(ThemesConversationList.PREF_UNREAD_BG, 0x00000000));
            mFromView.setTextColor(sp.getInt(ThemesConversationList.PREF_UNREAD_CONTACT, 0xff222222));
            mSubjectView.setTextColor(sp.getInt(ThemesConversationList.PREF_UNREAD_SUBJECT, 0xff222222));
            mDateView.setTextColor(sp.getInt(ThemesConversationList.PREF_UNREAD_DATE, 0xff222222));
        } else {
            setBackgroundColor(sp.getInt(ThemesConversationList.PREF_READ_BG, 0x00000000));
            mFromView.setTextColor(sp.getInt(ThemesConversationList.PREF_READ_CONTACT, 0xff222222));
            mSubjectView.setTextColor(sp.getInt(ThemesConversationList.PREF_READ_SUBJECT, 0xff222222));
            mDateView.setTextColor(sp.getInt(ThemesConversationList.PREF_READ_DATE, 0xff222222));
        }
    }
