...
import android.database.Bitmap;
    ...
    private static void updateNotification(
        ...
        if (isNew) {
            ...
            String ringtoneStr = sp.getString(MessagingPreferenceActivity.NOTIFICATION_RINGTONE,
                    null);
            notificaitonbuilder.setSound(TextUtils.isEmpty(ringtoneStr) ? null : Uri.parse(ringtoneStr));
		}
        ...
        notificationbuilder.setDeleteIntent(PendingIntent.getBroadcast(context, o,
		...
		notification.flags |= Notificaiton.FLAG_SHOW_LIGHTS;
